...
`Session01` hiện là trang giới thiệu **Nhóm 06** cho bài thực hành ET4711. Trang hiển thị hai thành viên **Phạm Chí Dũng** (MSSV **20250922E**) và **Nguyễn Hoàng Nam** (MSSV **20250169E**), năm mục tiêu học tập và một nút tạo lời chào. Khi nhấn nút, JavaScript đổi nội dung thông báo ngay trên trang mà không tải lại trang.
...
### Bước 4 — Chuyển nội dung sang giới thiệu nhóm

Theo thông tin được bổ sung sau đó, trang được cập nhật cho **Nhóm 06**. Phần đầu trang và thanh điều hướng dùng tên nhóm; phần **Thành viên** liệt kê rõ hai người cùng MSSV. Nội dung mục tiêu chuyển sang cách diễn đạt của cả nhóm. Nút tương tác tạo lời chào có tên và MSSV của cả hai thành viên. Phần mục tiêu học tập vẫn được giữ để thể hiện nội dung CP1 của bài lab.

## 3. Những cải tiến so với mã khởi đầu

| Khía cạnh | Mã khởi đầu | Kết quả hiện tại |
| --- | --- | --- |
| Nội dung | Giới thiệu mẫu, chưa có mục tiêu | Giới thiệu Nhóm 06, hai thành viên với MSSV và năm mục tiêu cụ thể |
| Tương tác DOM | Lời chào mẫu | Lời chào có thông tin cả hai thành viên, đổi màu trạng thái và có hiệu ứng ngắn khi nhấn |
| Bố cục | Các khung nội dung đơn giản | Hero, thanh điều hướng, thẻ thành viên, danh sách mục tiêu và khu vực tương tác có phân cấp rõ |
| Giao diện | Nền sáng, một màu nhấn xanh | Bảng màu xanh đen/kem/vàng, gradient và họa tiết CSS |
| Màn hình nhỏ | Chỉ giảm khoảng đệm ở `560px` | Thẻ thành viên và bố cục mục tiêu chuyển thành một cột, điều hướng và chữ điều chỉnh ở `850px`/`600px` |
...
1. Trang có tên Nhóm 06, đúng họ tên và MSSV của hai thành viên, năm mục tiêu và các liên kết điều hướng hoạt động.
2. Trước khi nhấn nút, `#message` hiển thị `Chưa có thông báo.`; sau khi nhấn, nội dung đổi thành `Xin chào! Chúng mình là Nhóm 06: Phạm Chí Dũng (20250922E) và Nguyễn Hoàng Nam (20250169E).`.
